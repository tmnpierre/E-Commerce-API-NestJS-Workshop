...
43. Créer une méthode dans le service `Products` pour récupérer tous les articles d'un utilisateur.
44. Créer une route pour récupérer les articles d'un utilisateur (en fonction de l'UUID de l'utilisateur).
45. Créer une route pour supprimer tous les articles d'un utilisateur.
