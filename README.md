...
10. Ajouter le nouveau controller en tant que controller du module `App` ([solution de l'étape](https://github.com/benjGam/E-Commerce-API-NW/tree/10-ajouter-le-service-au-module))
