...
10. Ajouter le controlleur `Product` à la liste des controlleurs du module `App` ([solution de l'étape](https://github.com/benjGam/E-Commerce-API-NW/tree/10-ajouter-le-controlleur-au-module))
